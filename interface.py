...
serverDir = "//Users/Jera/Documents/pesquisa/pd/dynamic\ patching/step3"
#replace this to where pdsend file is (COMPLETY DIRECTORY)
pdsendDir = "//Applications/audio/Pd-extended.app/Contents/Resources/bin"
#the port used
port = 3005
...
while 1:    
    ...
    os.system("cd //Applications/audio/Pd-extended.app/Contents/Resources/bin && echo %s | ./pdsend %d" %(msg, port))
